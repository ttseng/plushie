...
4. `+ Add New Gesture` to record samples of your gesture.  You have 2 seconds to record the gesture.  You'll be able to view the x, y, and z accelerometer plot after each sample and remove individual samples as needed.
5. When you have at least 3 samples of 2 or more gestures, you can click `Train Model` to build the machine learning model based on the data samples.
6. After the model is trained, you can test out the gesture recognizer.

## Tips
* If you find that a paticular gesture is not being recognized, you can add more samples to see if the model improves, or you can adjust the `confidence threshold`. 
